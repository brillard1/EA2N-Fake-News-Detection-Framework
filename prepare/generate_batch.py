...
train_dataset = "./amr_data/amr_2.0_"+DATASET_NAME+"/ea2n/train.pred.txt"
dev_dataset = "./amr_data/amr_2.0_"+DATASET_NAME+"/ea2n/dev.pred.txt"
test_dataset = "./amr_data/amr_2.0_"+DATASET_NAME+"/ea2n/test.pred.txt"
