...
class RelationEncoder(nn.Module):
    ...
    def forward(self, src_tokens, src_lengths):
        ...
        # print('src_tokens', src_tokens.size()) #[3, 35]
        # print('src_lengths', src_lengths) #[35]
        seq_len, bsz = src_tokens.size()
        torch.set_printoptions(profile="full")
        #print(src_tokens, 'src_tokens')  # [3, 35]
        sorted_src_lengths, indices = torch.sort(src_lengths, descending=True)
        sorted_src_tokens = src_tokens.index_select(1, indices)
        #print(sorted_src_tokens, 'sorted_src_tokens') 
        # print(sorted_src_lengths, 'src_lengths') #[35]
        ...
        # print(final_h.size(), 'final_h') # [2, 35, 512]
        # print(final_h[-1].size(), 'final_h[-1]') #[35, 512]
        output = self.out_proj(final_h[-1])
        # print('output_!!!', output.size())# [35, 512]
